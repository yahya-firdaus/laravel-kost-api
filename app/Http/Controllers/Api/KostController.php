...
class KostController extends Controller
{
     ...
     * @OA\Put(
     *     path="/api/kost/{kost}",
     *     summary="Update a kost by ID",
     *     description="Updates a kost by its ID",
     *     tags={"Kost"},
     *     @OA\Parameter(
     *         name="kost",
     *         in="path",
     *         required=true,
     *         description="ID of the kost to update",
     *         @OA\Schema(
     *             type="integer"
     *         )
     *     ),
     ...
     *         @OA\MediaType(
     *             mediaType="application/json",
     *             @OA\Schema(ref="#/components/schemas/UpdateKostRequest")
     *         )
     *     ),
     *     @OA\Response(
     *         response=200,
     *         description="Kost updated successfully",
     *         @OA\JsonContent(
     *             type="object",
     *             @OA\Property(
     *                 property="message",
     *                 type="string",
     *                 example="Kost updated successfully"
     *             ),
     *             @OA\Property(
     *                 property="data",
     *                 type="object",
    ...
    public function update(UpdateKostRequest $request, Kost $kost)
    {
        try {
            ...
            return ApiResponse::error(
                message: "Failed to update kost: {$e->getMessage()}",
                statusCode: Response::HTTP_INTERNAL_SERVER_ERROR
            );
        }
    }
     ...
     * @OA\Delete(
     *     path="/api/kost/{kost}",
     *     summary="Delete a kost by ID",
     *     description="Deletes a kost by its ID",
     *     tags={"Kost"},
     *     @OA\Parameter(
     *         name="kost",
     *         in="path",
     *         required=true,
     *         description="ID of the kost to delete",
     *         @OA\Schema(
     *             type="integer"
     *         )
     *     ),
     ...
     *                 property="message",
     *                 type="string",
     *                 example="Kost deleted successfully"
     *             )
     *         )
     *     ),
     *     @OA\Response(
    ...
    public function destroy(Kost $kost)
    {
        try {
            ...
            return ApiResponse::success(message: 'Kost deleted successfully', statusCode: Response::HTTP_NO_CONTENT);
        } catch (\Exception $e) {
            return ApiResponse::error(
                message: "Failed to delete kost: {$e->getMessage()}",
                statusCode: Response::HTTP_INTERNAL_SERVER_ERROR
            );
        }
    }
